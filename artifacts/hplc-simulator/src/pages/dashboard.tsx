...
export default function DashboardPage() {
  ...
  const cards = [
    ...
    },
    {
      ...
      action: () => { setActiveTab("sessions"); window.scrollTo({ top: 0, behavior: "smooth" }); },
      cta: "View Sessions",
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <Button
              ...
              onClick={() => { setActiveTab("sessions"); window.scrollTo({ top: 300, behavior: "smooth" }); }}
            >
      ...
      <div className="border-b bg-card sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-0">
            {([
            ...
            ] as ["overview" | "sessions", string, React.ElementType][]).map(([id, label, Icon]) => (
              <button
                key={id}
              ...
              >
                ...
                {id === "sessions" && sessions.length > 0 && (
                  <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${activeTab === "sessions" ? "bg-blue-100 text-blue-700" : "bg-muted text-muted-foreground"}`}>
                    {sessions.length}
                  </span>
                )}
              </button>
            ...
            <div className="flex items-center justify-between gap-4 pb-4 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{sessions.length} session{sessions.length !== 1 ? "s" : ""} saved</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                {/* Live search */}
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-64 h-8 pl-8 pr-7 text-xs rounded-lg border border-border bg-muted/30 placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-400/40 focus:border-blue-300 transition-all"
                  />
                  {sessionSearch && (
                          ...
                          <tr
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-blue-700 truncate max-w-[180px]" title={s.name}>{s.name}</span>
                              </div>
                            </td>
