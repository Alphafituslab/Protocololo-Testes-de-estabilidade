...
import {
  useListContainerTypes, useListCapsuleTypes,
  ...
  getListContainerTypesQueryKey, getListCapsuleTypesQueryKey,
  type CatalogItem,
...
import { Plus, Pencil, Trash2, Check, X, Package, Pill } from "lucide-react";

type CatalogSection = "container" | "capsule";
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Gerencie os tipos de pote e cápsula utilizados nos protocolos.
        </p>
      </div>
      ...
      <UnlockDialog
        ...
        onSuccess={() => {
          ...
          else deleteCapsule.mutate({ id: pendingDelete.id });
        }}
