...
const DEFAULT_METHODOLOGIES = [
  ...
  { shortName: "FB 7ª ed. — pH", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008. Método: 017/IV.", category: "Fisico-Quimica", subject: "pH", parameter: "pH", criteria: "Conforme especificação do produto" },
  { shortName: "FB 7ª ed. — Perda por dessecação", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008. Método: 012/IV.", category: "Fisico-Quimica", subject: "Perda por dessecação", parameter: "Perda por dessecação", criteria: "≤ 5%" },
  { shortName: "Inspeção visual", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008. Método: 060/IV.", category: "Fisico-Quimica", subject: "Aspecto", parameter: "Aparência", criteria: "Conforme padrão aprovado" },
  { shortName: "FB 7ª ed. — Cinzas totais", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008. Método: 018/IV.", category: "Fisico-Quimica", subject: "Cinzas totais", parameter: "Cinzas totais", criteria: "≤ 50%" },
  { shortName: "FB 7ª ed. — Dissolução", citation: "Farmacopeia Brasileira, 7ª edição (2024), Método Geral 5.5.1.5 – Dissolução.\nAplicação: ensaios de dissolução aplicáveis a formas farmacêuticas sólidas orais", category: "Fisico-Quimica", subject: "Dissolução", parameter: "Dissolução", criteria: "Q ≥ 80% em 30 min" },
  { shortName: "FB 7ª ed. — Massa média", citation: "Farmacopeia Brasileira, 7ª edição (2024), Método Geral 5.1.1 – Determinação de Peso, MG5.1.1-00.\nAplicação: controle de peso aplicável a formas farmacêuticas sólidas e semissólidas, conforme critérios compendiais.", category: "Fisico-Quimica", subject: "Massa média", parameter: "Massa média", criteria: "± 7,5%" },
  { shortName: "RDC 429/2020", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008.", category: "Fisico-Quimica", subject: "Valor energético e sódio", parameter: "Kcal", criteria: "Conforme declaração do rótulo" },
  { shortName: "IAL — Sódio", citation: "Métodos físico-químicos para análise de alimentos, 4. ed. São Paulo: Instituto Adolfo Lutz, 2008. Método: 017/IV.", category: "Fisico-Quimica", subject: "Sódio", parameter: "Sódio", criteria: "≤ 5 mg — declarar 0" },
  // Microbiológica
  ...
  { shortName: "FB 7ª ed. — Coliformes totais", citation: "CompactDry™ CF: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Coliformes totais", parameter: "Coliformes totais", criteria: "≤ 10 UFC/g" },
  { shortName: "FB 7ª ed. — Salmonella", citation: "CompactDry™ SL: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Salmonella spp.", parameter: "Salmonella spp.", criteria: "Ausente em 25 g" },
  { shortName: "FB 7ª ed. — Estafilococos", citation: "CompactDry™ X-SA: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Estafilococos coagulase+", parameter: "Estafilococos coagulase+", criteria: "≤ 10 UFC/g" },
  { shortName: "FB 7ª ed. — Bolores e leveduras", citation: "CompactDry™ YMR / YM: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Bolores e leveduras", parameter: "Bolores e leveduras", criteria: "≤ 100 UFC/g" },
  { shortName: "FB 7ª ed. — E. coli", citation: "CompactDry™ EC: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Escherichia coli", parameter: "Escherichia coli", criteria: "Ausente em 1 g" },
  { shortName: "FB 7ª ed. — Enterobacteriaceae", citation: "CompactDry™ ETB: Instructions for Use. Tokyo: Nissui Pharmaceutical Co., Ltd., ano vigente.", category: "Microbiologica", subject: "Enterobacteriaceae", parameter: "Enterobacteriaceae", criteria: "Ausente" },
  ...
  // Teor do ativo
  { shortName: "FB 7ª ed. — Cálcio", citation: "Farmacopeia Brasileira, 7ª edição (2024), Método Geral IF077-00 – Determinação de Cálcio por Titulação Complexométricas.", category: "Teor do Ativo", subject: "Cálcio", parameter: "Cálcio", criteria: "Mín. 80% do valor declarado" },
  { shortName: "HPLC-UV — Vitamina D", citation: "Japanese Pharmacopoeia (JP), 18th ed. Tokyo: Ministry of Health, Labour and Welfare (MHLW), 2021. Monograph \"Cholecalciferol\" – Compendial criteria for identity, purity and assay.", category: "Teor do Ativo", subject: "Vitamina D", parameter: "Vitamina D", criteria: "Mín. 80% do valor declarado" },
  { shortName: "HPLC — Vitamina C", citation: "Farmacopeia Brasileira, 7ª edição. Método Geral IF011-01 – Determinação de Ácido Ascórbico por Cromatografia Líquida de Alta Eficiência (CLAE/HPLC).", category: "Teor do Ativo", subject: "Vitamina C", parameter: "Vitamina C (Ácido Ascórbico)", criteria: "Mín. 80% do valor declarado" },
  { shortName: "HPLC — Vitamina E", citation: "United States Pharmacopeia–National Formulary (USP–NF), 2023, Monografia \"Vitamin E\"", category: "Teor do Ativo", subject: "Vitamina E", parameter: "Vitamina E (Tocoferol)", criteria: "Mín. 80% do valor declarado" },
  ...
  { shortName: "AOAC 984.27 — Magnésio", citation: "Farmacopeia Brasileira, 7ª edição, Volume 1, Capítulo Geral MG.5.3.3.4 (Titulações Complexométricas)", category: "Teor do Ativo", subject: "Magnésio", parameter: "Magnésio", criteria: "Mín. 80% do valor declarado" },
  { shortName: "FB 7ª ed. — Zinco", citation: "Farmacopeia Brasileira, 7ª edição (2024), Método Geral 5.3.3.4 – Titulações Complexométricas, aplicado à determinação de zinco", category: "Teor do Ativo", subject: "Zinco", parameter: "Zinco", criteria: "Mín. 80% do valor declarado" },
  { shortName: "FB 6ª ed. — Ferro", citation: "Farmacopeia Brasileira, 6ª edição (2019), Monografia IF316-00 – Sulfato Ferroso Heptaidratado", category: "Teor do Ativo", subject: "Ferro", parameter: "Ferro", criteria: "Mín. 80% do valor declarado" },
  ...
  // Embalagem
  { shortName: "ASTM D3474", citation: "Procedimento Operacional Padrão (POP) nº 047. Içara: Alphafitus Suplementos Ltda., 2024. Documento interno.", category: "Embalagem", subject: "Torque de tampa", parameter: "Torque de tampa", criteria: "Conforme especificação do fabricante" },
  { shortName: "ASTM F88", citation: "Procedimento Operacional Padrão (POP) nº 049. Içara: Alphafitus Suplementos Ltda., 2024. Documento interno.", category: "Embalagem", subject: "Selagem por indução", parameter: "Selagem por indução", criteria: "Sem falhas de selagem" },
  { shortName: "ASTM D4169", citation: "Procedimento Operacional Padrão (POP) nº 050. Içara: Alphafitus Suplementos Ltda., 2024. Documento interno.", category: "Embalagem", subject: "Integridade de embalagem", parameter: "Integridade selagem", criteria: "Ausência de vazamento" },
  { shortName: "Headspace GC", citation: "BRASIL. Agência Nacional de Vigilância Sanitária. Farmacopeia Brasileira. 6. ed. Brasília: ANVISA, 2019. v. 1.", category: "Embalagem", subject: "Headspace", parameter: "Headspace", criteria: "15% - 20%" },
  // Estabilidade
