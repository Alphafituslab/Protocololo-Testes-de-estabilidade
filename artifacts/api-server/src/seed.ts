...
const DEFAULT_METHODOLOGIES = [
  ...
  { shortName: "FB 7ª ed. — Magnésio", citation: "Farmacopeia Brasileira, 7ª edição, Volume 1, Capítulo Geral MG.5.3.3.4 (Titulações Complexométricas)", category: "Teor do Ativo", subject: "Magnésio", parameter: "Magnésio", criteria: "Mín. 80% do valor declarado" },
