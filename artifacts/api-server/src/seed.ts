...
const DEFAULT_METHODOLOGIES = [
  ...
  { shortName: "Headspace GC", citation: "INTERNATIONAL ORGANIZATION FOR STANDARDIZATION. ISO 11885:2007 — Water quality — Determination of selected elements by inductively coupled plasma optical emission spectrometry. Geneva: ISO, 2007. / Método interno de análise de headspace por cromatografia gasosa.", category: "Embalagem", subject: "Headspace", parameter: "Headspace", criteria: "15% - 20%" },
  // Estabilidade
