...
router.post("/protocols/:id/lots", requireAuth, async (req, res): Promise<void> => {
...
router.put("/protocols/:id/lots/:lotId", requireAuth, async (req, res): Promise<void> => {
...
router.delete("/protocols/:id/lots/:lotId", requireAuth, async (req, res): Promise<void> => {
